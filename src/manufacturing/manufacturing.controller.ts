...
export class ManufacturingController {
  ...
  async startManufacturing(@Request() req, @Body() data: StartManufacturingDto) {
    return this.manufacturingService.startManufacturing(req.user.userId, req.user.assigned_location_id, data, req.user.roles);
  }
  ...
  async closeManufacturing(@Request() req, @Body() data: CloseManufacturingDto) {
    return this.manufacturingService.closeManufacturing(req.user.userId, req.user.assigned_location_id, data, req.user.roles);
  }
}
