...
export class MovementController {
  ...
  allocate(@Body() dto: WorkflowMovementDto, @Request() req) {
    return this.movementService.recordMovement({ ...dto, new_status: 'Allocated' }, req.user.userId);
  }
  ...
  accept(@Body() dto: WorkflowMovementDto, @Request() req) {
    return this.movementService.recordMovement({ ...dto, new_status: 'Accepted' }, req.user.userId);
  }
  ...
  repair(@Body() dto: WorkflowMovementDto, @Request() req) {
    return this.movementService.recordMovement({ ...dto, new_status: 'Repair' }, req.user.userId);
  }
  ...
  shopOut(@Body() dto: WorkflowMovementDto, @Request() req) {
    return this.movementService.recordMovement({ ...dto, new_status: 'Shop Out' }, req.user.userId);
  }
  ...
  wrs5Fit(@Body() dto: WorkflowMovementDto, @Request() req) {
    return this.movementService.recordMovement({ ...dto, new_status: 'Fit' }, req.user.userId);
  }
  ...
  dispatch(@Body() dto: WorkflowMovementDto, @Request() req) {
    return this.movementService.recordMovement({ ...dto, new_status: 'Dispatched' }, req.user.userId);
  }
}
